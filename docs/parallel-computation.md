...
This is also embedded into the [HF_Access_flood_PAK_vector.ipynb](/notebooks/HF_Access_flood_PAK_vector.ipynb) notebook for its integration with the rest of the analysis:
